...
static size_t vecSort_PARTITION(T)(VEC_NAME *self, boolean(*lessThan)(T*, T*), size_t lo, size_t hi) {
...
static void vecSort_QUICKSORT(T)(VEC_NAME *self, boolean(*lessThan)(T*, T*), size_t lo, size_t hi) {
   T *l = vecAt(T)(self, lo);
   T *h = vecAt(T)(self, hi);
...
void vecSort(T)(VEC_NAME *self, boolean(*lessThan)(T*, T*)) {
