...
boolean stringEqualRaw(String *s1, const char *s2) {
   size_t len1 = stringLen(s1);
...
boolean stringStartsWith(const char *s1, const char *s2, boolean caseSensitive) {
...
boolean stringPtrCompare(StringPtr *str1, StringPtr *str2) {
