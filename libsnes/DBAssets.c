...
void dbImageDestroyStatements(DB_DBAssets *db);
int dbImageCreateTable(DB_DBAssets *db);
void dbPaletteDestroyStatements(DB_DBAssets *db);
int dbPaletteCreateTable(DB_DBAssets *db);
void dbSpriteDestroyStatements(DB_DBAssets *db);
int dbSpriteCreateTable(DB_DBAssets *db);
void dbSpriteFrameDestroyStatements(DB_DBAssets *db);
int dbSpriteFrameCreateTable(DB_DBAssets *db);
void dbTileSchemaDestroyStatements(DB_DBAssets *db);
int dbTileSchemaCreateTable(DB_DBAssets *db);
void dbLuaScriptDestroyStatements(DB_DBAssets *db);
int dbLuaScriptCreateTable(DB_DBAssets *db);
void dbMapDestroyStatements(DB_DBAssets *db);
int dbMapCreateTable(DB_DBAssets *db);
...
int dbImageUpdate(DB_DBAssets *db, const DBImage *obj){
   int result = 0;
...
int dbPaletteUpdate(DB_DBAssets *db, const DBPalette *obj){
   int result = 0;
...
int dbSpriteUpdate(DB_DBAssets *db, const DBSprite *obj){
   int result = 0;
...
int dbSpriteFrameUpdate(DB_DBAssets *db, const DBSpriteFrame *obj){
   int result = 0;
...
int dbTileSchemaUpdate(DB_DBAssets *db, const DBTileSchema *obj){
   int result = 0;
...
int dbLuaScriptUpdate(DB_DBAssets *db, const DBLuaScript *obj){
   int result = 0;
...
int dbMapUpdate(DB_DBAssets *db, const DBMap *obj){
   int result = 0;
